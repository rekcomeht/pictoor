...
convert $source.$ext -dither FloydSteinberg -define dither:diffusion-amount=85% -remap eink-3color.png BMP3:~pictoor/RaspberryPi_JetsonNano/python/pic/$source.bmp
